...
class GardenTree implements Serializable {
    ...
    public void printCreationTime() {
        ...
        System.out.println("creation time: " + dateOut);

    }
    public String toString() {
        String transplantInfo = needsTransplant() ? "needs transplant"
                : "doesn't need to transplant";
        return new String("tree "+ treeNumber + ": "
                + type + ", " + transplantInfo + " ");
    }
